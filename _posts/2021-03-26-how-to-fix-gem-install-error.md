---
layout: post
title: How to fix gem install error - Failed to build gem native extension
categories: [how-to, gem]
excerpt: You are trying to install a Ruby gem but installation is failing with an error something like this,
---
