...
I came across an article by [Kev Quirk](https://kevq.uk/) on his blog where he pondered on about using a better term than "Google it" when referring to a web search to be performed on [DuckDuckGo](https://duckduckgo.com/). Here are a few alternatives Kev came up with and quickly discarded. I'm quoting the following straight from his [blog post](https://kevq.uk/is-there-a-better-term-than-google-it/),
